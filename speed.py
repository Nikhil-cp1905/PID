...
def update_speed(pos_x):
    """Update the speed based on the slider position."""
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                ...
                if w_button.collidepoint(pos):
                    send_command(64 + int(43 * current_speed / 100))  # Move motor 1 forward
                    send_command(192 + int(43 * current_speed / 100))  # Move motor 2 forward
                elif s_button.collidepoint(pos):
                    send_command(64 - int(43 * current_speed / 100))  # Move motor 1 backward
                    send_command(192 - int(43 * current_speed / 100))  # Move motor 2 backward
