...
# Define points for each letter in the word "AYUSH"
# A simplified representation of each letter using line segments
points = {
    'A': [(0, 0), (0.5, 1), (1, 0), (0.25, 0.5), (0.75, 0.5)],  # A
    'Y': [(1.5, 1), (2, 0.5), (2.5, 1), (2, 0.5), (2, 0)],      # Y
    'U': [(3, 1), (3, 0), (4, 0), (4, 1)],                      # U
    'S': [(4.5, 1), (5, 1), (4.5, 0.5), (4.5, 0), (5, 0)],      # S
    'H': [(5.5, 1), (5.5, 0), (5.5, 0.5), (6, 0.5), (6, 1), (6, 0)]  # H
}
...
ani = FuncAnimation(fig, update, frames=len(x_points), init_func=init, blit=True, interval=100, repeat=False)
